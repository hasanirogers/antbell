        ...
        foreach ( $this->settings_fields as $section => $field ) {
            foreach ( $field as $option ) {
                ...
                if ( $is_pro ) {
                    ...
                    $label .= '<a class="vpf-settings-control-pro-label" target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pro/?utm_source=plugin&utm_medium=settings_page&utm_campaign=' . esc_attr( $name ) . '&utm_content=2.15.3">?<span>' . esc_html__( 'This feature is available in the Pro plugin only.', 'visual-portfolio' ) . '</span></a>';
                }
